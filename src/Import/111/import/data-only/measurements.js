// $this->createTable('{{measurement_systems}}', [
// 			'id' => 'int (11) UNSIGNED PRIMARY KEY',
// 			'title' => 'varchar (20) NOT NULL',
// 			'alias' => 'varchar (20) NOT NULL',
// 		], 'ENGINE=InnoDB DEFAULT CHARSET=utf8');
//
// 		$this->createIndex('uniq_title', '{{measurement_systems}}', 'title', true);
// 		$this->createIndex('uniq_alias', '{{measurement_systems}}', 'alias', true);
//
