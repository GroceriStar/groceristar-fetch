...
var getGroceryByName = function getGroceryByName(name) {
  return filterGroceriesByName(_files.groceries, name);
...
var getGroceriesWithDepIngKey = function getGroceriesWithDepIngKey() {
  // let result = []
  var result = _.map(_files.groceries, function (grocery) {
...
var getGroceryByNameWithDepAndIngKey = function getGroceryByNameWithDepAndIngKey(name) {
  ...
  var grocery = filterGroceriesByName(_files.groceries, name); // @TODO this is not a clean turn around for this method
  ...
  grocery[0]['departments'].forEach(function (department) {
    ...
    var dep = _.find(_files.departments, function (o) {
...
var getGroceryListsWithCountDepartments = function getGroceryListsWithCountDepartments() {
  return _.map(_files.groceries, function (item) {
    var object = {
      id: item.id,
      name: item.name,
...
var getAllDepartments = function getAllDepartments() {
  ...
  _.forEach(_.range(0, _files.groceries.length), function (value) {
    return departments.push.apply(departments, _toConsumableArray(_.map(_files.groceries[value]['departments'])));
  });
...
var getAllDepartmentList = function getAllDepartmentList() {
  return _.map(_files.departments, function (item) {
    return {
      key: __generateId(),
      departmentName: item
    };
...
var getAllIngredientsWithId = function getAllIngredientsWithId() {
  ...
  var result = getResult(_files.ingredients);
  return result;
...
var getAllDepartmentsWithId = function getAllDepartmentsWithId() {
  return getResult(_files.departments);
}; // ------------------------------
...
var createNewGroceryList = function createNewGroceryList(newDepartment) {
  var nameExists = _.find(_files.groceries, function (item) {
...
var getGroceryListsByDepartment = function getGroceryListsByDepartment(department) {
  ...
  if (department) {
    ...
    _files.groceries.map(function (grocery) {
...
exports.createNewGroceryList = createNewGroceryList;
exports.getAllDepartmentList = getAllDepartmentList;
exports.getAllDepartments = getAllDepartments;
exports.getAllDepartmentsWithId = getAllDepartmentsWithId;
exports.getAllGrocery = getAllGrocery;
exports.getAllGroceryDepartment = getAllGroceryDepartment;
exports.getAllIngredientsByOneDepartment = getAllIngredientsByOneDepartment;
exports.getAllIngredientsByOneDepartmentKey = getAllIngredientsByOneDepartmentKey;
exports.getAllIngredientsList = getAllIngredientsList;
exports.getAllIngredientsWithId = getAllIngredientsWithId;
exports.getCountIngOfDepartment = getCountIngOfDepartment;
exports.getDepartments = getDepartments;
exports.getGroceriesWithDepIngKey = getGroceriesWithDepIngKey;
exports.getGroceryById = getGroceryById;
exports.getGroceryByName = getGroceryByName;
exports.getGroceryByNameWithDepAndIng = getGroceryByNameWithDepAndIng;
exports.getGroceryByNameWithDepAndIngKey = getGroceryByNameWithDepAndIngKey;
exports.getGroceryListsByDepartment = getGroceryListsByDepartment;
exports.getGroceryListsWithCountDepartments = getGroceryListsWithCountDepartments;
exports.getIngredients = getIngredients;
exports.getKeyArrayDepAndIng = getKeyArrayDepAndIng;
